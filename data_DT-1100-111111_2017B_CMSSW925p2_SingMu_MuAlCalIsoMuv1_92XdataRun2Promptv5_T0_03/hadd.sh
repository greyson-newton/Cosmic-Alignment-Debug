...
if [ "$ALIGNMENT_ITERATION" != "111" ] || [ "$ALIGNMENT_ITERATION" == "3" ]; then
  #nfiles=$(ls data_DT-1100-111111_2017B_CMSSW925p2_SingMu_MuAlCalIsoMuv1_92XdataRun2Promptv5_T0_03/plotting*.root 2> /dev/null | wc -l)
  if [ "zzz$ALIGNMENT_PLOTTINGTMP" != "zzz" ]; then
    hadd -f1 -k data_DT-1100-111111_2017B_CMSSW925p2_SingMu_MuAlCalIsoMuv1_92XdataRun2Promptv5_T0_03/data_DT-1100-111111_2017B_CMSSW925p2_SingMu_MuAlCalIsoMuv1_92XdataRun2Promptv5_T0_03_plotting.root data_DT-1100-111111_2017B_CMSSW925p2_SingMu_MuAlCalIsoMuv1_92XdataRun2Promptv5_T0_03/plotting*.root
    #if [ $? == 0 ] && [ "$ALIGNMENT_CLEANUP" == "True" ]; then rm data_DT-1100-111111_2017B_CMSSW925p2_SingMu_MuAlCalIsoMuv1_92XdataRun2Promptv5_T0_03/plotting*.root; fi
  fi
fi
